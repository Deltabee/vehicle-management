...
customApp.controller('vendorController',['$scope','$route', '$http','$compile','$location', 'DTOptionsBuilder', 'DTColumnBuilder', function ($scope,$route, $http,$compile,$location,DTOptionsBuilder,DTColumnBuilder) {
        ...
        function actionsHtml(data, type, full, meta) {
            $d = full;
            return '<a href="#/editVendor/'+$d.id+'" title="Edit Vendor"><i class="material-icons">mode_edit</i></a>&nbsp;<a class="deleteOnGoingTrip" href="javascript:void(0)" title="Delete Vendor" ng-click="vendor.delete('+$d.id+')"><i class="material-icons">delete</i></a>';
        }
